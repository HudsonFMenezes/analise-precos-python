...
![Evolução de preços](data/img/evolucao_precos.png)
...
![Preço médio por produto](data/img/media_produtos.png)
...
![Preço médio por loja](data/img/media_loja.png)
...
![Avaliação vs preço](data/img/relacao_avaliacao_preco.png)
